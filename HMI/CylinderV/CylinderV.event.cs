...
namespace HMI.Main.Symbols.CylinderV
{
  partial class sDefault
  {
    ...
    private event EventHandler<HMI.Main.Symbols.CylinderV.INDEventArgs> IND_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (IND_Fired != null)
          {
            try
            {
              IND_Fired(this, new HMI.Main.Symbols.CylinderV.INDEventArgs(channelId, cookie, eventIndex));
            }
